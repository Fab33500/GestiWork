...
$isOpcoFinanceurTier = (($clientData['type'] ?? '') === 'financeur' || ($clientData['type'] ?? '') === 'opco');
                                                            ...
                                                            <button
                                                             ...
                                                             <?php if (! $isContactLockedTier) : ?>
                                                                 <form method="post" action="" style="margin:0;">
                                                                     ...
                                                                     $canDeleteAssociatedApprenant = !$isOpcoFinanceurTier && $hasLinkedApprenant;
                                                                     ?>
